    ...
    <div className="navbar bg-base-100 shadow-xl sticky top-0 z-50">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          >
            ...
            <li>
              <Link href="/Jundrel_CV.pdf" target="_blank" rel="noopener noreferrer" className="btn btn-outline btn-primary btn-sm">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
      ...
      <div className="navbar-center hidden md:flex">
        <ul className="menu menu-horizontal px-1">
          ...
          <li>
            <Link href="/coming-soon" target="_blank" rel="noopener noreferrer" className="btn  mr-6 sm:mr-10 btn-outline btn-primary flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
